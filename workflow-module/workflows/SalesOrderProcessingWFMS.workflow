{
	"contents": {
		"802c0ec5-4df9-40ed-bb0a-fd3fc605bb1e": {
			...
			"id": "salesorderprocessingworkflowms",
			"subject": "SalesOrderProcessingWorkflowMS",
			"name": "SalesOrderProcessingWorkflowMS",
		...
		"44190cf0-e404-4bd9-915b-cc6834590848": {
			...
			"formReference": "/forms/SalesOrderProcessingWorkflowMS/ApprovalForm.form",
			"userInterfaceParams": [{
				"key": "formId",
				"value": "approvalform"
			}, {
		...
		"e0bddc44-f07f-4d9c-974d-e51ff168828e": {
			...
			"userInterface": "sapui5://comsapbpmworkflow.comsapbpmwusformplayer/com.sap.bpm.wus.form.player",
			"recipientUsers": "panagiotis.petsas@consolut.com",
			"formReference": "/forms/SalesOrderProcessingWorkflowMS/ItemDetailsForm.form",
			"userInterfaceParams": [{
				"key": "formId",
		...
		"eff8f4d9-1b9a-441c-81fc-1e88c5f13fb4": {
			...
			"reference": "/sample-data/SalesOrderProcessingWorkflowMS/WorkflowInput.json",
